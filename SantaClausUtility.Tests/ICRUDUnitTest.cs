...
namespace SantaClausUtility.Tests
{
    ...
    {
        [TestMethod]
        public void Create_Method_Should_Return_A_Generic_Object()
        {
        ...
        [TestMethod]
        public void Read_Method_Should_Return_A_Generic_Object()
        {
            Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>> mock = new Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>>();
        ...
        [TestMethod]
        public void Update_Method_Should_Return_A_Generic_Object()
        {
            Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>> mock = new Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>>();
        ...
        [TestMethod]
        public void Delete_Method_Should_Return_A_Generic_Object()
        {
            Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>> mock = new Mock<ICRUD<Database<IMongoDatabase>, DatabaseSettings>>();
